  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData({ username: "", password: "", name: "", role: "PEMBELI" }); // Clear form
            ...
            <div className="w-full h-[500px] rounded-lg overflow-hidden shadow-xl">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent">
                <div className="absolute bottom-6 left-6 text-white">
                  <h2 className="text-3xl font-bold mb-2">Join BrewForce</h2>
                  <p className="text-sm opacity-90">Start your coffee journey today</p>
                </div>
              </div>
            </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 mt-8">
              <div className="bg-white p-4 rounded-lg shadow">
                <div className="flex items-center mb-2">
                  ...
                  <span className="ml-2 font-medium text-amber-900">Member Benefits</span>
                </div>
                <p className="text-sm text-amber-700">Exclusive offers and rewards</p>
              </div>
              <div className="bg-white p-4 rounded-lg shadow">
                <div className="flex items-center mb-2">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-amber-800" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <span className="ml-2 font-medium text-amber-900">Quick Access</span>
                </div>
                <p className="text-sm text-amber-700">Fast and secure ordering</p>
              </div>
            </div>
          </div>
